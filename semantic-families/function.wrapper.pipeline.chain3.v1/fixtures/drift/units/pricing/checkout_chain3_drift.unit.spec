id: pricing/checkout_chain3_drift
kind: function
spec_version: "0.3.0"
intent:
...
local_tests:
  - id: checkout_chain3_drift_basic
    expect: checkout_chain3_drift(Decimal::new(10000, 2), Decimal::new(10, 2), Decimal::new(10, 2), Decimal::new(10, 2), Decimal::new(10, 2)) == Decimal::new(9900, 2)
