id: pricing/pricing_discount_leaf_under_specified
kind: function
spec_version: "0.3.0"
intent:
...
local_tests:
  - id: pricing_discount_leaf_under_specified_basic
    expect: pricing_discount_leaf_under_specified(Decimal::new(10000, 2), Decimal::new(10, 2)) == Decimal::new(9000, 2)
